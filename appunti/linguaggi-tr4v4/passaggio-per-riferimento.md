...
Un altro grande beneficio di questa modalita' di passaggio e' il fatto che sia piu' efficiente di quello per valore: non devo copiare il parametro attuale in quello formale (si pensi a [[oggetto|oggetti]] di grandi dimensione come in [[java|Java]]).
