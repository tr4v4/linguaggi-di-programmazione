...
## Funzionamento
Nella pratica l'overloading e' un'abbreviazione sintattica che scompare non appena risolviamo l'invocazione. Di fatto l'overloading e' un meccanismo di **[[dispatch|dispatch]]** (indirizzamento).
