...
- tante righe quanti gli stati dell'automa $LR(0)$ ([[dfa-dei-prefissi-viabili|DFA dei prefissi viabili]]);
...
Di fatto **e' possibile costruire $LALR(1)$ direttamente dall'automa $LR(0)$**! Questa tecnica e' quella usata da [[yacc|YACC]].
