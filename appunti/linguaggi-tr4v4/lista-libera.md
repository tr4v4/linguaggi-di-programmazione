...
2. se il blocco scelto è più grande (di almeno il doppio del necessario), allora viene diviso in due, e la parte rimanente viene aggiunta alla lista libera;
