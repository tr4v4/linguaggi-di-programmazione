...
---
## Introduzione
Abbiamo visto che con l'[[algoritmo|algoritmo]] di [[costruzione-per-sottoinsiemi|costruzione per sottoinsiemi]] è possibile ottenere un [[dfa|DFA]] a partire da qualunque [[nfa|NFA]]. Tuttavia, _se l'NFA ha $n = |Q|$ stati, il DFA equivalente potrebbe avere $2^{n}$ stati_.
