...
links:
  - "[[lecture-08102024111650|Lecture 08102024111650]]"
---
# Costruzione per sottoinsiemi
---
## Introduzione
> La tecnica di **costruzione per sottoinsiemi** (o **subset construction**) consiste in un [[algoritmo|algoritmo]] in grado di costruire un [[dfa|DFA]] a partire da un [[nfa|NFA]], tale che siano equivalenti (riconoscano lo stesso linguaggio).
...
### Analisi
Nel [[complessita-computazionale|caso pessimo]] si ha che
$$T = \mathscr{P}(Q)$$
ossia il numero di stati del DFA risultante è uguale a $2^{n}$ dove $n = |Q|$ ([[cardinalita|cardinalità]]).
