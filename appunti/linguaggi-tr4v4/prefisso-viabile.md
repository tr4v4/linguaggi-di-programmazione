...
## Teoremi
### Regolarita'
> Data $G$ grammatica libera, i prefissi viabili di $G$ costituiscono un [[linguaggio-regolare|linguaggio regolare]], che puo' essere descritto da un [[dfa|DFA]].

Questo teorema consente di costruire proprio il [[dfa-dei-prefissi-viabili|DFA dei prefissi viabili]].
