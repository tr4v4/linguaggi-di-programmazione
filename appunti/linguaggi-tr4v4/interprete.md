...
1. controllo e sfruttamento dell'[[alu|ALU]];
2. incremento del [[pc|PC]] e gestione dei [[salto-informatico|salti]];
3. gestione dei [[modalita-di-indirizzamento|metodi di indirizzamento]];
