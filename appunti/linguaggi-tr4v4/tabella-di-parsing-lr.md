...
---
## Introduzione
> Una **tabella di parsing $LR$** e' una matrice bidimensionale usata dai [[parser-lr|parser]] $LR$ per risolvere i conflitti shift-reduce e reduce-reduce. Viene calcolata attraverso il [[dfa-dei-prefissi-viabili|DFA dei prefissi viabili]].
...
## Referenze
- [[grammatiche-lr-0|Grammatiche LR(0)]]
- [[tabella-di-parsing-slr-1|Tabella di parsing SLR(1)]]
- [[tabella-di-parsing-lalr-1|Tabella di parsing LALR(1)]]