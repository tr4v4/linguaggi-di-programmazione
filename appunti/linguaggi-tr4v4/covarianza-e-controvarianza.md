...
## Java e C++
In [[java|Java]] e [[c|C++]] gli [[array|array]] sono [[generics|tipi parametrici polimorfi]], ma per ragioni storiche hanno reso le scritture e le letture covarianti!

Il sistema di tipi accetta quindi:
```java
Animal[] aa = new Dog[ 1 ];   // la violazione principale e' questa! Accesso in covariante nonostante sia controvariante!
