...
---
## Introduzione
> Il **borrow-checking** e' un meccanismo di protezione della memoria, implementato per esempio in [[rust|Rust]], che funziona limitando il modo in cui si possono utilizzare i [[puntatore|puntatori]].
...
Per ora e' tutto molto semplice: _si tratta semplicemente di un albero, a cui se viene deallocata la radice viene automaticamente deallocato ogni suo nodo_ (implementando una sorta di [[garbage-collection|garbage collection]] automatico).
