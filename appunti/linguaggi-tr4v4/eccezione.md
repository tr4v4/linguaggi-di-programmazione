...
links:
  ...
  - "[[lecture-24042025131115|Lecture 24042025131115]]"
---
# Eccezione
---
## Introduzione
...
#### Eccezioni
Il blocco `catch` fa riferimento a un'eccezione, [[sottotipaggio|sottotipo]] di `Throwable`, legata a un nome. In [[java|Java]] la gerarchia di sottotipaggio dei `Throwable` è la seguente:
![[throwable-java.png]]
...
- al sollevamento di un’eccezione:
	- ricerca binaria nella tabella del ProgCounter sul primo elemento (`block_addr`)
	- trasferimento del controllo all’indirizzo corrispondente del gestore (`handler_addr`)
