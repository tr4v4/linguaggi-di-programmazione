...
---
## Introduzione
> Il **Dynamic Method Dispatch** e' un meccanismo di [[dynamic-dispatch|dynamic dispatch]] implementato dalla [[jvm|JVM]] in [[java|Java]] in grado di risolvere il problema della [[classe-base-fragile|classe base fragile]].
