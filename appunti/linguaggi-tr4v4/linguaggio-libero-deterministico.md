...
links:
  - "[[lecture-22102024110521|Lecture 22102024110521]]"
  - "[[lecture-24102024120228|Lecture 24102024120228]]"
---
# Linguaggio libero deterministico
---
## Introduzione
> Un [[linguaggio-formale|linguaggio]] si dice **libero deterministico** se è [[linguaggio-accettato|accettato]] _per stato finale_ da un [[dpda|DPDA]].
...
$$L = \{ww^{R} | w \in \{a, b\}^{*}\}$$
Questo sappiamo essere libero. Infatti abbiamo creato l'[[npda|NPDA]] che lo accettava. Ma si può dimostrare che non esiste un DPDA che lo riconosce!
...
Ovvio, ci basta creare un DPDA che si comporta come il [[dfa|DFA]] che riconosce $L$ senza mai manipolare lo stack.
