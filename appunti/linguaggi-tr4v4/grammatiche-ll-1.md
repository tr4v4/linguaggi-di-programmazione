...
#### Dimostrazione
Se $L$ e' regolare allora $\exists$ un [[dfa|DFA]] $M = (\Sigma, Q, \delta, q_{0}, F)$ tale che $L = L[M]$. A partire da $M$ costruiamo la grammatica regolare $G = (NT, T, S, R)$ con $NT = \{[q] | q \in Q\}$[^2], $T = \Sigma$, $S = [q_{0}]$ e $R$ definita da:
...
## Referenze
- [[grammatiche-ll-k|Grammatiche LL(k)]]
