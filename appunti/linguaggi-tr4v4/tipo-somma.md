...
## Rappresentazione
Alcuni linguaggi, come [[rust|Rust]], hanno esteso la loro definizione dei [[tipi-di-base-enum|tipi enum]] per catturare il caso dei tipi di somma. [[java|Java]] invece usa le `sealed` classes. In [[c|C]] si usano le `union` (ma a quel punto non c'e' differenza tra un tipo della somma e l'altro...).
