...
Quando al puntatore si assegna un valore, e' in realta' la tombstone a contenere l'indirizzo: **il puntatore riceve l'indirizzo dalla tombstone**.
...
In questo modo, si risolvono i problemi scaturiti dalla duplicazione dei puntatori, ovvero quando due puntatori puntano alla stessa cella ([[aliasing|aliasing]]). In tal caso, infatti, **la tombstone rimane attiva** (aperta) **finche' l'oggetto da essa puntato** (il reale elemento) **e' allocato**.
