...
In [[js|JS]], per esempio, definisco un oggetto e i suoi attributi cosi':
```js
function Counter() {
	this.x = 1;
}
...
Di solito i casi in cui un prototipo ha un suo prototipo, avvengono per implementare l'[[ereditarieta|ereditarieta']].
