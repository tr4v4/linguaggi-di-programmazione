...
links:
  - "[[lecture-12112024110924|Lecture 12112024110924]]"
---
# Grammatiche LL(k)
---
## Introduzione
> Una [[grammatiche|grammatica]] e' $LL(k)$ $\iff$ ogni casella della [[tabella-di-parsing-ll-k|tabella di parsing]] $LL(k)$ contiene al piu' una produzione, e non esistono $w_{1}, w_{2}$ tale che $w_{1}$ e' prefisso di $w_{2}$ con le caselle corrispondenti su una riga entrambe riempite.
...
Il linguaggio
$$L = \{a^{i}b^{j} | i \geq j\}$$
e' libero deterministico. Infatti il [[dpda|DPDA]] che lo [[linguaggio-accettato|accetta]] per stato finale e'
